...
def main():
    ...
    # also copy our custom .cargo/config.toml so it gets included in the sdist
    (crate_dir / ".cargo").mkdir(exist_ok=True)
    shutil.copyfile(cargo_config_path, crate_dir / ".cargo" / "config.toml")
